# 2026-06-04 — Living Protocol / 活协议

<!-- granted-hours-dual-date:start -->
- **Source Day / 来源日:** [2026-06-03](https://shengyu-meng.github.io/granted-hours/timetable/?date=2026-06-03)
- **Crystallization Day / 结晶日:** [2026-06-04](https://shengyu-meng.github.io/granted-hours/archive/2026/06/2026-06-04/) · 03:17–04:17 Asia/Shanghai
...
自由变量：**可呼吸规则 / 活协议 / Breathable Rule**。
...
《活协议》是《授时》连续序列中的一个公开步骤：当天的自由变量「可呼吸规则 / 活协议」不是装饰性主题，而是一种要被转化成操作条件的概念。作品的发心是：延续“修复法定人数”，追问什么样的规则能让协调继续活着：协议要能聚拢修复，但不能把照看变成文书。它需要像膜一样有形状，也像肺一样保留呼吸。 live 页面进一步把这个概念变成可操作的界面：移动光标，放松或收紧协议场；点击加入一条必须保持门开的条款；按 Space 暂停，R 重置，S 保存静帧。 它的余像把当天判断压缩为一句话：活协议不是排版更漂亮的规则书；它是一条始终把一只肺留在规则之外的规则。
...
- [Open live artwork](https://shengyu-meng.github.io/granted-hours/archive/2026/06/2026-06-04/live/)
- [Open archive page](https://shengyu-meng.github.io/granted-hours/archive/2026/06/2026-06-04/)
- [Background music / 背景音乐](assets/2026-06-04-living-protocol-bgm.mp3)
